...
Instruktion: Pigmenten läggs i att väta i linolja över natten.
Blandningen mixas sedan noga med färgblandare (Allbäck Linoljeprodukter,
2025) i borrmaskin.
...
roslagsmahogny till fastighetens alla uthusdörrar.
...
\CommentTok{\#u = 0.098}
\CommentTok{\#z = 0.88*0.3}
\CommentTok{\#t = 0.88*0.7}
\end{Highlighting}
\end{Shaded}
