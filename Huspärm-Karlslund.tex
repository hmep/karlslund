...
Godsstråket genom Bergsslagen (Wikipedia 2025a). I byn finns en livaktig
föreningsverksamhet, ofta med samlingspunkt i Paviljongen, som angränsar
till Karslund (Föreningen Sällinge by 2025).
...
\section*{Recept på
färgblandningar}\label{recept-puxe5-fuxe4rgblandningar}
\addcontentsline{toc}{section}{Recept på färgblandningar}

\markright{Recept på färgblandningar}

Följande dokumenterar recepten för de egenblandade färger som använts på
Karlslund från 2024 och framåt. Recepten är skapade för att vara enkla
att reproducera med enhetligt resultat. De kan med fördel justeras med
valfri mängd extra linolja eller annat förekommande bindmedel, utifrån
behov och önskemål.

\subsection*{Linoljefärg}\label{linoljefuxe4rg}
\addcontentsline{toc}{subsection}{Linoljefärg}

\subsubsection*{\texorpdfstring{\protect\pandocbounded{\includegraphics[keepaspectratio]{plåtfärg.jpg}}Rostskyddsfärg
till plåt och
järn}{Rostskyddsfärg till plåt och järn}}\label{rostskyddsfuxe4rg-till-pluxe5t-och-juxe4rn}
\addcontentsline{toc}{subsubsection}{Rostskyddsfärg till plåt och järn}

Takstegen, avloppsventilationsstosen och plåtkragningen kring skorstenen
är i oktober 2025 målade med följande grundfärg i 2 strykningar.

Pigmenten läggs i att väta i linolja. Blandningen mixas sedan noga med
färgblandare (Allbäck Linoljeprodukter 2025) i borrmaskin.

\begin{itemize}
\tightlist
\item
  1 del (vikt; 50 g) zinkoxid (Kremer Pigmente 2025a)
\item
...
\subsubsection*{Slutstrykningsfärg till plåt och
järn}\label{slutstrykningsfuxe4rg-till-pluxe5t-och-juxe4rn}
\addcontentsline{toc}{subsubsection}{Slutstrykningsfärg till plåt och
järn}

Takstegen, avloppsventilationsstosen och plåtkragningen kring skorstenen
är i oktober 2025 målade med följande grundfärg i 1--2 strykningar, för
...
\subsection*{Roslagsmahogny/tjäroljefärg}\label{roslagsmahognytjuxe4roljefuxe4rg}
\addcontentsline{toc}{subsection}{Roslagsmahogny/tjäroljefärg}

\subsubsection*{\texorpdfstring{\protect\pandocbounded{\includegraphics[keepaspectratio]{vattbräda.jpg}}Vattbrädor
tak}{Vattbrädor tak}}\label{vattbruxe4dor-tak}
\addcontentsline{toc}{subsubsection}{Vattbrädor tak}

Vattbrädorna i trä är målade i oktober 2025 med nedanstående
pigmenterade roslagsmahogny i 1 första strykning för att efterlikna
takteglets kulör, och harmoniera med linoljefärgen på takets plåtbeslag.

Bindmedel och terpenting blandas först, varpå pigmenten läggs i att
väta. Blandningen mixas sedan noga med färgblandare (Allbäck
Linoljeprodukter 2025) i borrmaskin.

\begin{itemize}
\tightlist
\item
  1 del (vikt; 75 g) zinkoxid (Kremer Pigmente 2025a)
\item
  1 del Järnmönja (Claessons träjära 2025)
\item
  1 del Gul järnoxid (Kremer Pigmente 2025b)
...
\subsection*{Äggoljetempera}\label{uxe4ggoljetempera}
\addcontentsline{toc}{subsection}{Äggoljetempera}

\subsubsection*{Väggfärg ``Evas
ljusgula''}\label{vuxe4ggfuxe4rg-evas-ljusgula}
\addcontentsline{toc}{subsubsection}{Väggfärg ``Evas ljusgula''}

Vinyltapeten från 1980-talet i ett av sovrummen målas som en
``snabbrenovering'' med följande färg i 2 strykningar.

Samtliga pigment läggs att väta i vatten i en skål över natten.
Pigmentpastan mixas med stavmixer. Ägg och olja mixas samman i ett
separat kärl och blandas sedan ned i pigmentpastan. Färgen justeras med
valfri mängd vatten till underlaget och önskad känsla i pensel/roller.
...
\item
  10 delar krita (Kremer Pigmente 2025c)
\item
...
\item
  10 delar ägg
\item
  10 delar kokt linolja (Boställets lin 2025)
\end{itemize}
...
Allbäck Linoljeprodukter. 2025. {``Färgblandaren Hans -- Metall.''}
...
Boställets lin. 2025. {``Kallpressad Kokt Linolja.''}
...
\url{https://claessons.com/roda/jarnmonja-406/?srsltid=AfmBOorErhq8bFMcyk6jv3bjyyRyfCVm846RSkANjcmNOSIf1U-H4YpF}.
...
Föreningen Sällinge by. 2025. {``Sällinge by -- Natur, Kultur,
...
Riksförbundet Svensk trädgård. 2025. {``Digitala Zonkartan -- Hitta Din
Odlingszon!''}
