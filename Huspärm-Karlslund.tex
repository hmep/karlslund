...
\subsection[Rostskyddsfärg till plåt och
järn]{\texorpdfstring{\protect\pandocbounded{\includegraphics[keepaspectratio]{plåtfärg.jpg}}Rostskyddsfärg
till plåt och
...
tak]{\texorpdfstring{\protect\pandocbounded{\includegraphics[keepaspectratio]{vattbräda.jpg}}Roslagsmahogny/tjäroljefärg
till vattbrädor
...
används gärna direkt för den första inarbetningen i underlaget (med
anstrykare), med med ökande tillsats kokt linolja i mellan- och
slutstrykningen (med moddlare), utifrån målningsprincipen ``från magert
till fett''. För ökad glans kan sista strykningen innehålla upp till 5
...
\NormalTok{cp }\OtherTok{\textless{}{-}} \FloatTok{0.12}       \CommentTok{\# färgprocenten}
\NormalTok{wp }\OtherTok{\textless{}{-}} \DecValTok{1}\FloatTok{{-}0.12}     \CommentTok{\# vitprocenten (räknas ut)}
\NormalTok{zp }\OtherTok{\textless{}{-}} \FloatTok{0.3}        \CommentTok{\# zinkprocenten }
\NormalTok{tp }\OtherTok{\textless{}{-}} \DecValTok{1}\FloatTok{{-}0.3}      \CommentTok{\# titanprocenten (räknas ut)}

\NormalTok{u }\OtherTok{=}\NormalTok{ tp}\SpecialCharTok{*}\NormalTok{(wp}\SpecialCharTok{*}\NormalTok{zp}\SpecialCharTok{*}\FloatTok{2.02}\SpecialCharTok{/}\FloatTok{2.7}\SpecialCharTok{+}\NormalTok{wp}\SpecialCharTok{*}\NormalTok{tp)}
\NormalTok{u }\OtherTok{=} \FloatTok{0.098}
\NormalTok{z }\OtherTok{=} \FloatTok{0.88}\SpecialCharTok{*}\FloatTok{0.3}
\NormalTok{t }\OtherTok{=} \FloatTok{0.88}\SpecialCharTok{*}\FloatTok{0.7}
\end{Highlighting}
\end{Shaded}
...
gärna direkt för den första inarbetningen i underlaget (med anstrykare),
med med ökande tillsats kokt linolja i mellan- och slutstrykningen (med
moddlare), utifrån målningsprincipen ``från magert till fett''. För ökad
glans kan sista strykningen innehålla upp till 5 \%
\hyperref[sec-linolja-soloxiderad]{soloxiderad linolja}.
