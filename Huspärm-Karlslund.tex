...
\subsubsection*{Rostskyddsfärg till plåt och
järn}\label{rostskyddsfuxe4rg-till-pluxe5t-och-juxe4rn}
\addcontentsline{toc}{subsubsection}{Rostskyddsfärg till plåt och järn}

\includegraphics[width=0.25\linewidth,height=\textheight,keepaspectratio]{plåtfärg.jpg}Takstegen,
avloppsventilationsstosen och plåtkragningen kring skorstenen är i
oktober 2025 målade med följande grundfärg i 2 strykningar.
...
\subsubsection*{Vattbrädor tak}\label{vattbruxe4dor-tak}
