...
\subsection*{Utomhus}\label{utomhus}
\addcontentsline{toc}{subsection}{Utomhus}
...
målades i oktober 2025 med följande grundfärg i 2 strykningar.
...
Instruktion: Pigmenten läggs i att väta i linolja. Blandningen mixas
sedan noga med färgblandare (Allbäck Linoljeprodukter, 2025) i
borrmaskin.
...
\subsubsection*{\texorpdfstring{\protect\pandocbounded{\includegraphics[keepaspectratio]{vattbräda.jpg}}Roslagsmahogny/tjäroljefärg
till vattbrädor
tak}{Roslagsmahogny/tjäroljefärg till vattbrädor tak}}\label{roslagsmahognytjuxe4roljefuxe4rg-till-vattbruxe4dor-tak}
\addcontentsline{toc}{subsubsection}{Roslagsmahogny/tjäroljefärg till
vattbrädor tak}

Vattbrädorna i trä målades i oktober 2025 med nedanstående pigmenterade
...
läggs i att väta. Blandningen mixas sedan noga med färgblandare (Allbäck
Linoljeprodukter, 2025) i borrmaskin.

\subsection*{Inomhus}\label{inomhus}
\addcontentsline{toc}{subsection}{Inomhus}

\subsubsection*{Linoljefärg vit 3\% grön umbra
(pasta)}\label{linoljefuxe4rg-vit-3-gruxf6n-umbra-pasta}
\addcontentsline{toc}{subsubsection}{Linoljefärg vit 3\% grön umbra
(pasta)}
...
tillsats kokt linolja i mellan- och slutstrykningen (utifrån
målningsprincipen ``från magert till fett''). Nedanstående mängd bereds
och förvaras med fördel i en 1-liters färgburk i plåt (Bauhaus, 2025).

\begin{itemize}
\tightlist
\item
  20 g grön umbra (Kremer Pigmente, 2025c)
\item
  1020 g titandioxid (Kremer Pigmente, 2025d)
\item
  120 g zinkvitt (Kremer Pigmente, 2025a)
\item
  500 g kokt linolja (Hagberg, Tobias, 2025)
\end{itemize}

Instruktion: Pigmenten läggs i att väta i linolja över natten. Den
tjocka blandningen mixas sedan mycket noga med färgblandare (Allbäck
Linoljeprodukter, 2025) i borrmaskin.

\subsubsection*{Äggoljetempera ljusgul
väggfärg}\label{uxe4ggoljetempera-ljusgul-vuxe4ggfuxe4rg}
\addcontentsline{toc}{subsubsection}{Äggoljetempera ljusgul väggfärg}
