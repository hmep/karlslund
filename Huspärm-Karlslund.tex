...
\section{Faluröd slamfärg}\label{faluruxf6d-slamfuxe4rg}

\subsection{Ingredienser (viktprocent)}\label{ingredienser-viktprocent}
...
Caput Mortuum Synthetic 180 M & 18 \% & 1,8 kg & \#48220
(huvudpigment) \\
(Valfritt) Caput Mortuum violet & -- & 50--100 g (för nyansjustering) &
\#48750 \\
...
\subsection{Säkerhet}\label{suxe4kerhet}
...
\subsection{Steg-för-steginstruktioner}\label{steg-fuxf6r-steginstruktioner}

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\item
  \textbf{Förbered mjölklistret}\\
  Blanda mjölet med lite kallt vatten till en klumpfri, tunn
  pannkakssmet.
\item
  \textbf{Koka basen}\\
  Häll resten av vattnet i en stor gryta (minst 15 liter). Rör i
  järn(II)sulfat tills det löst sig helt. Koka upp under omrörning.
\item
  \textbf{Tillsätt mjöl och pigment}\\
  Häll i mjölblandningen under kraftig omrörning. Låt sjuda 5 minuter.
  Tillsätt pigmentet lite i taget (Caput Mortuum \#48220 + ev. lite
  \#48750). Låt sjuda ytterligare 15 minuter. Tillsätt ev. zinksulfat
  nu.
\item
  \textbf{Blanda i linoljan}\\
  Ta grytan från plattan. Häll i linoljan i en tunn stråle samtidigt som
  du vispar kraftigt så att oljan emulgerar (undvik att den lägger sig
  som en hinna ovanpå).
\item
  \textbf{Vila och använd}\\
  Låt färgen svalna och vila minst 1 dygn. Rör om väl före användning.
  Måla tunt (ca 100--150 ml/m² per strykning) på obehandlat eller
  tidigare rödfärgsbehandlat trä.
\end{enumerate}
...
\item
  Testa alltid på en liten yta först; nyansen kan variera beroende på
  träslag och pigmentbatch.
\item
  För ljusare nyans: minska pigmentmängden med 10--20 \%.
\item
  För mörkare/violettare ton: öka andelen Caput Mortuum violet
  (\#48750).
\end{itemize}
