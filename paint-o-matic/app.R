...
PIGMENT_DISPLAY_GROUPS <- list(
  ...
  "Gröna" = c("40400", "41700", "41750", "11100", "11000", "KG83", "ZG65", "40850", "40860", "GU30"),
...
ui <- dashboardPage(
  dashboardHeader(
    ...
    tags$li(
      class = "dropdown",
      tags$a(href = "https://github.com/hmep/karlslund/blob/main/paint-o-matic/LICENSE", class = "version-text", "v0.10.19-fast, © 2025 Tobias Hagberg, licens GPLv3")
    )
  ),
